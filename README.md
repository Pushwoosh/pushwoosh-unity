...
```
https://github.com/Pushwoosh/pushwoosh-unity.git?path=com.pushwoosh.unity.core#6.2.11
```
...
{
  "dependencies": {
    "com.pushwoosh.unity.core": "6.2.11",
    "com.pushwoosh.unity.android": "6.2.11",
    "com.pushwoosh.unity.ios": "6.2.11"
  },
  "scopedRegistries": [
    {
      "name": "npmjs",
